...
<body>
	<div id="backnya">
		<div id="info">
			...
			<p style="display: block;font-weight: bold;color: white;" id="giliranJalan">HITAM</p>
		</div>
		<div id="papanCatur">
			...
			<?php for ($i=0; $i < 8; $i++): ?>
				<div class="bidakCatur" onclick="if(banyakJalan == 0){pionPutih[<?php echo $i ?>].onClickPion();}" id="pionPutih<?php echo $i ?>">&#9823</div>

				<div class="bidakCatur" id="pionHitam<?php echo $i ?>">&#9817</div>
			<?php endfor; ?>


			<div class="bidakCatur" id="bentengPutih0" onclick="if(banyakJalan == 0){bidakPutih[0].onClickBidak();}">&#9820</div>
			<div class="bidakCatur" id="bentengPutih7" onclick="if(banyakJalan == 0){bidakPutih[7].onClickBidak();}">&#9820</div>
			<div class="bidakCatur" id="kudaPutih1"  onclick="if(banyakJalan == 0){bidakPutih[1].onClickBidak();}">&#9822</div>
			<div class="bidakCatur" id="kudaPutih6"  onclick="if(banyakJalan == 0){bidakPutih[6].onClickBidak();}">&#9822</div>
			<div class="bidakCatur" id="gajahPutih2"  onclick="if(banyakJalan == 0){bidakPutih[2].onClickBidak();}">&#9821</div>
			<div class="bidakCatur" id="gajahPutih5"  onclick="if(banyakJalan == 0){bidakPutih[5].onClickBidak();}">&#9821</div>
			<div class="bidakCatur" id="rajaPutih3"  onclick="if(banyakJalan == 0){bidakPutih[3].onClickBidak();}">&#9819</div>
			<div class="bidakCatur" id="rajaPutih4"  onclick="if(banyakJalan == 0){bidakPutih[4].onClickBidak();}">&#9818</div>

			<div class="bidakCatur" id="bentengHitam0">&#9814</div>
			<div class="bidakCatur" id="bentengHitam7">&#9814</div>
			<div class="bidakCatur" id="kudaHitam1">&#9816</div>
			<div class="bidakCatur" id="kudaHitam6">&#9816</div>
			<div class="bidakCatur" id="gajahHitam2">&#9815</div>
			<div class="bidakCatur" id="gajahHitam5">&#9815</div>
			<div class="bidakCatur" id="rajaHitam4">&#9813</div>
			<div class="bidakCatur" id="rajaHitam3">&#9812</div>
		</div>
...
?>
	...
	class Pion {
		...
		movePion(top,left) {
		    ...
		    this.param = "clickY="+ this.y + "&clickX=" + this.x + "&clickNo=" + this.nomor + "&nama=pionHitam&type=hitam&room=<?php echo $room ?>";
	...
	class Benteng {
		...
		moveBidak(top,left) {
		    ...
		    this.xhr = new XMLHttpRequest();
		    this.param = "clickY="+ this.y + "&clickX=" + this.x + "&clickNo=" + this.nomor + "&nama=bidakHitam&type=hitam&room=<?php echo $room ?>";
		    this.xhr.open('POST','kirim.php',true);
		    this.xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		    this.xhr.send(this.param);
		}
...
let mulai = setInterval(auto,500);
</script>
</html>